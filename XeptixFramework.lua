...
ModifiedObjects = {
	...
	["DataModel"] = {
		...
		Is = function(self, condition)
			...
			if condition == "Local" or condition == "LocalScript" or condition == "Client" then
				return game:GetService("RunService"):IsClient()
			elseif condition == "Studio" then
				return game:GetService("RunService"):IsStudio()
			elseif condition == "Server" or condition == "Script" then
				return game:GetService("RunService"):IsServer()
			elseif condition == "Run" or condition == "RunMode" or condition == "Running" then
